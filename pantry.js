...
const PANTRY = [
    ...
    { name: 'Chickpeas (canned)',         category: 'protein',   inStock: true,  unit: 'cans',   notes: '15g protein per cup cooked',            keywords: ['chickpea'] },
    ...
    { name: 'Sweet Potato',               category: 'carbs',     inStock: true,  unit: 'pieces', notes: '35g carbs per medium',                  keywords: ['sweet potato'] },
    ...
    { name: 'Avocado',                    category: 'fat',       inStock: true,  unit: 'pieces', notes: 'For guacamole & salads',                keywords: ['avocado'] },
    { name: 'Whole Flax Seeds',           category: 'fat',       inStock: true,  unit: 'bag',    notes: '2 tbsp daily — Omega-3 anti-inflammatory', keywords: ['flax'] },

    // ===== VEGETABLES =====
    { name: 'Spinach (Fresh)',            category: 'veggie',    inStock: true,  unit: 'bag',    notes: 'For breakfast, salads, bowls',           keywords: ['spinach'] },
    { name: 'Tomatoes',                   category: 'veggie',    inStock: true,  unit: 'pieces', notes: 'For salads, curries, omelettes',        keywords: ['tomato'] },
    { name: 'Cucumber',                   category: 'veggie',    inStock: true,  unit: 'pieces', notes: 'For salads & snack sticks',             keywords: ['cucumber'] },
    { name: 'Mushrooms',                  category: 'veggie',    inStock: true,  unit: 'pack',   notes: 'For night salads',                      keywords: ['mushroom'] },
    { name: 'Onions',                     category: 'veggie',    inStock: true,  unit: 'bag',    notes: 'Yellow/white, for curries',             keywords: ['onion'] },
    { name: 'Bell Peppers',              category: 'veggie',    inStock: true,  unit: 'pieces', notes: 'For stir-fry & egg muffins',            keywords: ['bell pepper', 'pepper'] },
    { name: 'Broccoli',                  category: 'veggie',    inStock: true,  unit: 'head',   notes: 'For salmon bowl',                       keywords: ['broccoli'] },
    { name: 'Frozen Mixed Veggies',       category: 'veggie',    inStock: true,  unit: 'bag',    notes: 'Quick lunch side',                      keywords: ['frozen mixed veggies', 'frozen veggies', 'mixed veggies'] },
    { name: 'Zucchini',                  category: 'veggie',    inStock: true,  unit: 'pieces', notes: 'For stir-fry',                          keywords: ['zucchini'] },
    { name: 'Baby Carrots',              category: 'veggie',    inStock: true,  unit: 'bag',    notes: 'For snacking with hummus',              keywords: ['carrot', 'baby carrot'] },
    { name: 'Green Chilies',             category: 'veggie',    inStock: true,  unit: 'pack',   notes: 'For masala omelette & curries',         keywords: ['green chili'] },
    { name: 'Cilantro',                  category: 'veggie',    inStock: true,  unit: 'bunch',  notes: 'Fresh, for garnish',                    keywords: ['cilantro'] },
    { name: 'Romaine Lettuce',           category: 'veggie',    inStock: true,  unit: 'head',   notes: 'For tandoori salad',                    keywords: ['romaine', 'lettuce'] },
    { name: 'Cherry Tomatoes',           category: 'veggie',    inStock: true,  unit: 'pack',   notes: 'For Mediterranean salad',               keywords: ['cherry tomato'] },
    { name: 'Frozen Peas',              category: 'veggie',    inStock: true,  unit: 'bag',    notes: 'For keema',                             keywords: ['pea', 'frozen peas'] },

    // ===== FRUITS =====
    { name: 'Kiwi',                       category: 'fruit',     inStock: true,  unit: 'pieces', notes: 'Mandatory — Potassium Flush',           keywords: ['kiwi'] },
    { name: 'Mandarin Oranges',           category: 'fruit',     inStock: true,  unit: 'bag',    notes: 'Afternoon snack',                       keywords: ['mandarin'] },
    { name: 'Banana',                     category: 'fruit',     inStock: true,  unit: 'bunch',  notes: 'For protein shakes',                    keywords: ['banana'] },
    { name: 'Lemon',                      category: 'fruit',     inStock: true,  unit: 'pieces', notes: 'Morning water + salad dressing',        keywords: ['lemon'] },
    { name: 'Apple',                      category: 'fruit',     inStock: true,  unit: 'pieces', notes: 'For snack with PB',                     keywords: ['apple'] },
    ...
    // ===== SPICES & CONDIMENTS =====
    { name: 'Turmeric',                  category: 'spice',     inStock: true,  unit: 'jar',    notes: 'Anti-inflammatory',                     keywords: ['turmeric'] },
    ...
    { name: 'Guacamole',                 category: 'spice',     inStock: true,  unit: 'tub',    notes: 'For night salads',                      keywords: ['guacamole'] },
